...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA5C7441c6bef7dCE530F8581e10680690aB15867;
...
contract MWIN is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x1c962969BB79114A54966fc8818b5b9293592c5C;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MWIN";
    string private _symbol = "MWIN";
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**3 * 10**18;
